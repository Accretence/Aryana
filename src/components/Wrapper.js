    ...
    <>
      ...
      <style jsx global>
        {`
          ...
          .avanti > .item {
            justify-content: ${isLocaleRTL(locale) ? 'end' : 'start'};
          }
          input::placeholder {
          ...
          .collapse > .view > .title > h3 {
            position: ${isLocaleRTL(locale) && 'absolute !important'};
            right: ${isLocaleRTL(locale) && '2.5rem !important'};
            direction: ${getLocaleDirection(locale)};
            text-align: ${getLocaleAlignment(locale)};
          }
          .collapse > .view {
            margin-bottom: ${isLocaleRTL(locale) && '0.6em !important'};
          }
          .collapse > .view > .subtitle {
            direction: ${getLocaleDirection(locale)};
            text-align: ${getLocaleAlignment(locale)};
            margin-top: ${isLocaleRTL(locale) && '0.6rem !important'};
          }
        `}
      </style>
    </>
